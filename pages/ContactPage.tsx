            ...
            <div className="bg-brand-900 rounded-2xl shadow-xl overflow-hidden p-8 text-white relative">
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-medium text-brand-200 text-sm uppercase mb-1">
                      销售热线
                    </p>
                    <a
                      href="tel:025-51819281"
                      className="text-xl font-bold hover:text-brand-300 transition-colors underline decoration-brand-600 underline-offset-4"
                    >
                      19337226600
                    </a>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg">779294618@qq.com</p>
                  </div>
                </div>
