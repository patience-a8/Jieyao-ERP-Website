    ...
    <div className="bg-white">
      ...
      <div className="relative bg-slate-900 py-24 sm:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-4xl font-extrabold sm:text-6xl mb-6">我们是桂捷</h1>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-start">
            ...
            <div>
              ...
              <div className="prose prose-lg text-slate-600 space-y-6">
                ...
                <p>
                  <strong>捷耀软件</strong>成立于2015年，专注于企业ERP软件销售，企业大型数据库如SQL SERVER, ORACLE等国际知名数据库销售及售后技术支持，目前捷耀有员工30名，公司业务分布江苏、四川、河南、广西、广东等省份。
                </p>
                <p>
                  <strong>桂捷软件</strong>成立于2021年，主要业务为智能设备研发、销售、玩具、成人玩具、初级农产品、企业管理咨询、信息化前沿技术研究等业务，公司立足于广西，面向东盟地区开展业务，目前在南宁同广西投资集团、广西农垦集团、广西产投集团、广西林业集团、广西轨道交通集团等建立广泛业务合作。
                </p>
                <p>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">桂捷ERP采用全平台适配架构，无论您的企业偏好何种基础设施，我们都能完美落地。</p>
          </div>
