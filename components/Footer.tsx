        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-slate-200 pb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start text-slate-600">
                ...
                <span>江苏省南京市软件大道88号<br/>科技创新园A座</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/features" className="text-slate-600 hover:text-brand-600 flex items-center group"><ArrowRight size={14} className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />核心功能</Link></li>
              <li><Link to="/pricing" className="text-slate-600 hover:text-brand-600 flex items-center group"><ArrowRight size={14} className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />价格方案</Link></li>
              <li><Link to="/about" className="text-slate-600 hover:text-brand-600 flex items-center group"><ArrowRight size={14} className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />关于我们</Link></li>
              <li><Link to="/contact" className="text-slate-600 hover:text-brand-600 flex items-center group"><ArrowRight size={14} className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />联系我们</Link></li>
            </ul>
          </div>
        </div>
